...
public class CheckpointManager extends AbstractPluginReceiver {
    ...
    public void createCheckpoint(Player player, @Nullable Integer checkpoint) {
        ...
        if (parkour.getDefaultConfig().isEnforceSafeCheckpoints()) {
            try {
                ...
                parkour.getDefaultConfig().set("Other.EnforceSafeCheckpoints", false);
        ...
        block.setType(parkour.getDefaultConfig().getCheckpointMaterial());

        CourseInfo.createCheckpointData(selectedCourse, location, checkpoint);
    ...
    public void deleteCheckpoint(CommandSender sender, String courseName) {
        ...
        Integer checkpoint = CourseInfo.getCheckpointAmount(courseName);
        ...
        CourseInfo.deleteCheckpoint(courseName);
