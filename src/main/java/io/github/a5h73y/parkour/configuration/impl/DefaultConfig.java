...
public class DefaultConfig extends Yaml {
	...
	public DefaultConfig(File path) {
		...
		this.setDefault("ParkourTool.Restart.SecondCooldown", 6);
		...
		this.setDefault("ParkourModes.Rockets.Delay", 1);
		...
		this.setDefault("Other.LogToFile", true);
		this.setDefault("Other.EnforceSafeCheckpoints", true);
		this.setDefault("Other.UseAutoTabCompletion", true);
		this.setDefault("Other.ParkourKit.ReplaceInventory", true);
		this.setDefault("Other.ParkourKit.GiveSign", true);
		this.setDefault("Other.ParkourKit.LegacyGroundDetection", false);
		this.setDefault("Other.Parkour.ChatRankPrefix.Enabled", false);
		this.setDefault("Other.Parkour.ChatRankPrefix.OverrideChat", true);
		...
		this.setDefault("Other.Display.ShowMilliseconds", false);
		...
		this.setDefault("Plugin.AAC.Enabled", true);
	...
	public String getAutoStartKey(@NotNull Block block) {
		String coordinates = block.getX() + "-" + block.getY() + "-" + block.getZ();

		if (this.getBoolean("AutoStart.IncludeWorldName")) {
